        ...
        <div className={'flex flex-col justify-between'} style={{minHeight: '100vh', color: `${color}`}}>
            <div className="w-full flex p-2">
                <div className="w-1/2">
                    ...
                    <img className={'rounded-2xl'} src={'https://webapp.syntxai.net/images/carousel/VEO3-min.jpg'}/>
                </div>
                <div className={'w-1/2'}>
                    <div className="flex flex-wrap gap-3 mb-4">
                        <Link
                            to={'/sub/'}
                            className={`rounded-xl w-[calc(50%-0.5rem)] hover:text-[#66EBE3] h-[70px] flex flex-col items-center justify-center gap-1`}
                    ...
                    <div className="px-2">
                        <div className="bg-white text-black px-4 py-2 rounded-t-xl flex justify-between items-center text-sm font-medium">
                            Присоединяйтесь
                            <DownOutlined />
                        </div>
                        ...
                        <div className="flex justify-between items-center py-3 border-b border-white/10">
                            ...
                            <div className={`rounded-full size-[25px] text-center`} style={{background: color}}>
                                <InstagramOutlined style={{fontSize: '16px', color: `${bgColor}`}}/>
                            </div>
                        </div>
